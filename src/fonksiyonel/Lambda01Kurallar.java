...
public class Lambda01Kurallar {
    ...
    public static void main(String[] args) {
        ...
        // forEach() bir collection'nın iterasyonu için kullanılan HOF.
        // Parametre olarak bir lambda fonksiyonu alabilir.
        liste.forEach(x ->System.out.print(x+" "));
        System.out.println("==========");

        //listenin elemanalrinin 2 artirilarak yazdralim.

        liste.forEach(t-> System.out.print(t+2 + " "));

        System.out.println("\nEger exprecion saysisi birden fazla olursa {} kullanmaliyiz..");
        liste.forEach(t-> {
                int miktar = 2;
                System.out.print(t+2 + " ");
        });

        System.out.println("Eger veri tipi kullnailirsa Explisit");
        liste.forEach((Integer x)->System.out.print(x*2 + " "));

        System.out.println();
        System.out.println("Bir dis degsiken kullanalim");
        int deger = 5;
        ...
        //Method refaransi ======>Class adi : : Method adi
